...
// ===== CITY DATA WITH GEO-TARGETING =====
const cities = [
  { name: 'Chitral',    img: cityChitral,    orders: '110+' },
  { name: 'Lahore',     img: cityLahore,     orders: '20+'  },
  { name: 'Karachi',    img: cityKarachi,    orders: '25+'  },
  { name: 'Faisalabad', img: cityFaisalabad, orders: '15+'  },
  { name: 'Islamabad',  img: cityKashmir,    orders: '40+'  },
  { name: 'Peshawar',   img: cityPeshawar,   orders: '200+' },
]
...
const structuredData = {
  ...
  name: 'M&J Traders',
  alternateName: 'MJ Traders Pakistan',
  description:
    'M&J Traders — Pakistan ka premium online electronics store. Original iPhones, Google Pixels, Laptops, Smart Watches, ACs, Inverters aur Audio accessories. 1-3 din mein doorstep delivery Peshawar, Chitral, Lahore, Karachi, Islamabad aur Faisalabad mein.',
  url: SITE_URL,
  logo: `${SITE_URL}/og-image.jpg`,
  image: OG_IMAGE,
  telephone: '+923487085930',
  priceRange: 'PKR',
  ...
  sameAs: [
    'https://www.facebook.com/profile.php?id=61582145015111',
    'https://www.instagram.com/idreesalzeyadi/',
    'https://www.tiktok.com/@m_j_traders',
  ],
  areaServed: [
    { '@type': 'City', name: 'Peshawar',   '@id': 'https://www.wikidata.org/wiki/Q9644' },
    { '@type': 'City', name: 'Chitral',    '@id': 'https://www.wikidata.org/wiki/Q668259' },
    { '@type': 'City', name: 'Lahore',     '@id': 'https://www.wikidata.org/wiki/Q1934' },
    { '@type': 'City', name: 'Karachi',    '@id': 'https://www.wikidata.org/wiki/Q8660' },
    { '@type': 'City', name: 'Islamabad',  '@id': 'https://www.wikidata.org/wiki/Q9240' },
    { '@type': 'City', name: 'Faisalabad', '@id': 'https://www.wikidata.org/wiki/Q211524' },
  ],
  hasOfferCatalog: {
    '@type': 'OfferCatalog',
    name: 'M&J Traders Electronics Catalog',
    itemListElement: [
      { '@type': 'OfferCatalog', name: 'iPhones & Smartphones' },
      { '@type': 'OfferCatalog', name: 'Laptops & PCs' },
      { '@type': 'OfferCatalog', name: 'Smart Watches' },
      { '@type': 'OfferCatalog', name: 'Google Pixel Phones' },
      { '@type': 'OfferCatalog', name: 'Audio & Earbuds' },
      { '@type': 'OfferCatalog', name: 'Power Banks & Accessories' },
    ],
  },
  aggregateRating: {
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Kya M&J Traders original iPhones sell karta hai?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Haan, M&J Traders 100% original aur genuine iPhones, Google Pixels aur baqi electronics sell karta hai Pakistan mein. Har product PTA approved ya CPID verified hota hai.',
      },
    },
    {
      '@type': 'Question',
      name: 'M&J Traders Pakistan mein konse cities mein deliver karta hai?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'M&J Traders Peshawar, Chitral, Lahore, Karachi, Islamabad, Faisalabad aur poore Pakistan mein 1-3 din mein doorstep delivery karta hai.',
      },
    },
    {
      '@type': 'Question',
      name: 'Kya M&J Traders mein installments available hain?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Haan, M&J Traders installment plans offer karta hai. WhatsApp pe contact karein: +923487085930.',
      },
    },
    {
      '@type': 'Question',
      name: 'M&J Traders se order kaise karein?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Website pe product select karein, Order Now click karein, ya seedha WhatsApp pe message karein. Cash on Delivery, JazzCash aur EasyPaisa accept hoti hai.',
      },
    },
  ],
}
        ...
        {carouselSlides.map((s, idx) => {
          ...
          return (
            <div key={idx} style={cardStyle} onClick={() => relPos !== 0 && goTo(idx)}>
              <img
                src={s.img}
                alt={`Premium ${s.label} available at M&J Traders Pakistan — buy online with fast delivery`}
...
function Home() {
  ...
  const handleOrderNow   = (product, e) => { e.stopPropagation(); navigate('/order', { state: { product, fromHome: true } }) }
  ...
  const metaDesc = isFiltering && activeCategory !== 'All'
    ? `Shop 100% original ${activeCategory} at M&J Traders Pakistan. Fast 1-3 day delivery to Peshawar, Lahore, Karachi, Islamabad & Chitral. Cash on Delivery available.`
    : 'M&J Traders Pakistan ka #1 premium electronics store. Original iPhones, Google Pixels, Laptops, Smart Watches, ACs & accessories. 1-3 day delivery to Peshawar, Lahore, Karachi, Islamabad, Chitral & all Pakistan. Cash on Delivery.'
  ...
  return (
    <div style={{ backgroundColor: '#000000', minHeight: '100vh', color: '#EEEEEE', overflowX: 'hidden' }}>
      ...
      <Helmet>
        ...
        <meta name="keywords" content="M&J Traders, online electronics Pakistan, buy iPhone Peshawar, original Google Pixel Pakistan, laptops Lahore, smart watches Karachi, electronics Chitral, buy iPhone online Pakistan, original Apple products Pakistan, Samsung phones Pakistan, PTA approved phones, non PTA phones Pakistan, electronics Islamabad, best price mobiles Pakistan, cash on delivery electronics Pakistan, M&J electronics store, buy electronics Faisalabad, online mobile store KPK" />
        <meta name="author" content="M&J Traders" />
        ...
        <meta property="og:title"        content="M&J Traders | Original iPhones, Laptops & Electronics Pakistan" />
        <meta property="og:description"  content="Pakistan ka #1 premium electronics store. Original iPhones, Google Pixels, Laptops, Smart Watches. 1-3 din mein delivery Peshawar, Lahore, Karachi, Islamabad, Chitral. Cash on Delivery." />
          ...
          <div style={{ flex: '1 1 320px', padding: 'clamp(24px,5vw,80px)', paddingTop: '60px', paddingBottom: '60px', position: 'relative', zIndex: 10 }}>
            ...
            <h1 style={{ margin: 0, marginBottom: '16px' }}>
              ...
              <AnimatePresence mode="wait">
                <motion.span key={currentWord} initial={{ opacity: 0, y: 25, rotateX: -80 }} animate={{ opacity: 1, y: 0, rotateX: 0 }} exit={{ opacity: 0, y: -25, rotateX: 80 }} transition={{ duration: 0.35 }}
                  style={{ display: 'block', fontSize: 'clamp(32px,5vw,68px)', fontWeight: 900, lineHeight: 1.1, color: '#CF0A0A' }}>
                  {heroWords[currentWord]}
                </motion.span>
              </AnimatePresence>
              <motion.span initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 }}
                style={{ display: 'block', fontSize: 'clamp(32px,5vw,68px)', fontWeight: 900, lineHeight: 1.1, color: '#EEEEEE' }}>
                At Best Prices
              </motion.span>
            </h1>
            ...
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}
              style={{ color: '#EEEEEE88', fontSize: '15px', maxWidth: '420px', marginBottom: '28px', lineHeight: 1.6 }}>
              Original iPhones, Google Pixels, Laptops, Smart Watches, ACs & more — fast 1–3 day delivery across Pakistan including Peshawar, Chitral, Lahore, Karachi & Islamabad!
            </motion.p>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.3 }} style={{ display: 'flex', gap: '28px', flexWrap: 'wrap' }}>
              {[
                { icon: '🤝', value: 1000, suffix: '+', label: 'Happy Customers' },
                { icon: '📦', value: 150,  suffix: '+', label: 'Products' },
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} style={{ textAlign: 'center', marginBottom: '48px' }}>
          {isFiltering ? (
            ...
            <>
              ...
              <p style={{ color: '#EEEEEE55', fontSize: '14px' }}>100% original products — best quality at unbeatable prices in Pakistan</p>
            </>
          )}
        ...
        <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px' }}>
            <div style={{ textAlign: 'center', marginBottom: '36px' }}>
              ...
              <p style={{ color: '#EEEEEE55', fontSize: '14px', maxWidth: '500px', margin: '0 auto' }}>Real reviews from verified M&J Traders customers across Pakistan</p>
            </div>
        ...
        <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px' }}>
            <div style={{ textAlign: 'center', marginBottom: '36px' }}>
              <motion.div initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }}
                style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: '#CF0A0A22', border: '1px solid #CF0A0A55', color: '#CF0A0A', padding: '6px 18px', borderRadius: '50px', fontSize: '11px', fontWeight: 700, letterSpacing: '2px', marginBottom: '14px' }}>
                <MapPin size={13} /> OUR DELIVERY REACH
              </motion.div>
              ...
              <p style={{ color: '#EEEEEE55', fontSize: '14px', maxWidth: '500px', margin: '0 auto' }}>
                Fast 1-3 day shipping to Peshawar, Chitral, Lahore, Karachi, Islamabad, Faisalabad & all of Pakistan!
              </p>
              <div style={{ width: '50px', height: '3px', background: 'linear-gradient(to right, #CF0A0A, #DC5F00)', margin: '12px auto 0', borderRadius: '2px' }} />
            </div>
              ...
              <div ref={cityScrollRef} style={{ display: 'flex', gap: '14px', overflowX: 'auto', padding: '8px 4px 20px', scrollSnapType: 'x mandatory', WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none', msOverflowStyle: 'none' }} className="hide-scrollbar">
                {cities.map((city, i) => (
                  <motion.div key={city.name} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.07 }} whileHover={{ y: -6, scale: 1.03 }}
                    ...
                    <motion.div initial={{ opacity: 0 }} whileHover={{ opacity: 1 }} style={{ position: 'absolute', inset: 0, border: '2px solid #CF0A0A55', borderRadius: '16px', pointerEvents: 'none' }} />
                  </motion.div>
                ))}
              </div>
              {!isMobile && (
      ...
      <footer style={{ backgroundColor: '#0a0a0a', borderTop: '1px solid #CF0A0A33', padding: '40px 16px 24px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '28px' }}>
            ...
            <p style={{ color: '#EEEEEE44', fontSize: '12px', letterSpacing: '1px' }}>Pakistan's Premium Electronics Store — Original Products, Best Prices</p>
          </div>
          ...
          <div style={{ borderTop: '1px solid #1f1f1f', paddingTop: '18px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
            <p style={{ color: '#EEEEEE22', fontSize: '11px' }}>© 2026 M&J Traders. All rights reserved. Pakistan's Premium Electronics Store.</p>
